import { AuctionCategoryEnum } from "@/utils/constant";
...
export interface IAuctionRequestParams {
  auction_item_category?: AuctionCategory | string;
  item_name?: string;
  cursor?: string;
}
...
export type CategoryItems = string[];

export type AuctionCategoryType = {
  [key in AuctionCategoryEnum]: CategoryItems;
};
